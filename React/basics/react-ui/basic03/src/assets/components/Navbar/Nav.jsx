...
const Nav = () => {
  ...
  return (
    <div
      ...
      flex justify-between py-2.5 px-5 sm:px-7 md:py-4 lg:py-5 lg:px-5 xl:px-9 xl:py-7 z-50 text-white transition-all duration-300
      ${isScrolled ? "bg-black/90 backdrop-blur-md" : "bg-transparent"}`}
    >
      <h2 className="font-bold text-[1.125rem] sm:text-[1.125rem] md:text-2xl lg:text-[1.375rem] xl:text-[1.200rem] cursor-pointer sm:top-0.5 sm:relative sm:left-2">
        LUMINU
      </h2>

      <ul
        className="hidden lg:flex lg:text-[1rem] xl:right-[21rem] lg:gap-x-8 lg:relative lg:right-48 lg:top-1 xl:top-[0rem]
"
      >
      ...
      <div>
        <span className="text-3xl relative right-2 md:right-5 bottom-0.5 cursor-pointer sm:text-[2rem] sm:relative sm:right-7 md:text-[2rem] md:top-1">
