...
const Nav = () => {
  return (
    <div className="fixed top-0 left-0 w-full h-14 lg:h-[4.6875rem] sm:h-[3.125rem] md:h-[4.0625rem] bg-transparent flex items-center lg:items-center justify-between px-6 lg:px-7 sm:px-7 sm:py-7 md:px-10 md:py-2 z-50 text-white md:bg-gray-800/20 md:backdrop-blur-sm">
      <h2 className="font-bold cursor-pointer sm:text-[1.125rem] md:text-2xl lg:text-[1.375rem]">
        LUMINU
      </h2>
      <ul className="hidden lg:flex lg:gap-x-9 lg:text-[1rem] lg:relative lg:right-[11rem]">
        <li>Home</li>
        <li>About</li>
        <li>Solutions</li>
        <li>Contact</li>
      ...
      <div>
        ...
        <div className="hidden lg:flex lg:bg-amber-50 lg:text-black lg:mr-2.5 lg:px-8 lg:py-2.5 lg:rounded-full">
