...
const Nav = () => {
  return (
    <div className="fixed top-0 left-0 w-full h-14 sm:h-[3.125rem] md:h-20 lg:h-[4.9rem] bg-transparent flex items-center justify-between px-6 sm:px-7 sm:py-7 md:px-12 z-50 text-white md:bg-gray-800/20 md:backdrop-blur-sm">
      <h2 className="font-bold cursor-pointer sm:text-[1.125rem] md:text-3xl lg:text-[1.7rem]">
        LUMINU
      </h2>
