...
const Special = () => {
  return (
    <div className="w-full h-[34.625rem] bottom-16 relative lg:h-[36rem] sm:-mt-8 font-semibold tracking-wider md:ml-[-0.7rem] md:pr-2 md:relative sm:relative sm:bottom-5 md:bottom-63 lg:relative lg:bottom-80 lg:mt-40">
