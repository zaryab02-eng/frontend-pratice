...
const NavHeading = () => {
  return (
    <div className="h-[6.125rem] flex justify-center items-center px-8 sm:px-10 sm:pb-3.5 md:relative md:bottom-7 lg:relative lg:pt-3.5 xl:relative xl:pt-6 xl:right-6">
