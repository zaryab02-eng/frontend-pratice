...
const QuickLink = () => {
  return (
    <div className="w-full py-2 h-min bottom-4.5 right-0.5 relative lg:h-[36rem] sm:-mt-8 font-semibold tracking-wider md:ml-[-0.7rem] md:pr-2 md:relative sm:relative sm:bottom-5 md:bottom-100 lg:relative lg:bottom-80 lg:mt-40 2xl:relative 2xl:left-12">
