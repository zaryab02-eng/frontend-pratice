...
const Apple = () => {
  return (
    <section
      className="w-full py-10 font-semibold tracking-wider md:tracking-tight md:font-extrabold overflow-hidden relative bottom-4 lg:bottom-42 xl:bottom-[17.20rem] xl:pl-18.5 xl:pr-19.5
 lg:left-0.5 sm:bottom-15 md:bottom-93 md:right-2"
    >
