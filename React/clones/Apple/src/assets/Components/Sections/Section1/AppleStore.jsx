...
const Apple = () => {
  return (
    <section className="w-full bg-white py-10 font-semibold tracking-wider md:tracking-tight md:font-extrabold overflow-hidden md:bottom-90 relative bottom-4 lg:bottom-42 xl:bottom-[17.20rem] xl:pl-18.5 xl:pr-19.5 lg:left-0.5 sm:bottom-15 md:right-2 2xl:relative 2xl:left-10">
