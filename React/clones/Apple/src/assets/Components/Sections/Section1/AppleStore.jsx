...
const Apple = () => {
  return (
    <div className="w-full h-[34.625rem] lg:h-[36rem] sm:-mt-8 font-bold tracking-wider md:ml-[-0.7rem] md:pr-2 md:relative md:bottom-63 lg:relative lg:bottom-44 lg:mt-40">
