...
const FooterNav = () => {
  return (
    <div className="h-[3.5625rem] bg-amber-400 w-full mt-2 flex items-center md:-translate-y-120 lg:-translate-y-20 xl:-translate-y-44 xl:pl-35 gap-x-2 pl-2.5 pt-1">
