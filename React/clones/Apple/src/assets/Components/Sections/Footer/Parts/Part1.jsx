const Part1 = () => {
  return (
    <>
      <div className="pl-4 pr-4.5 text-[0.75rem] mt-16.5 sm:mt-13 tracking-wide space-y-2 xl:space-x-4 leading-4 sm:leading-3.5 md:-translate-y-122 lg:-translate-y-20 xl:-translate-y-44 xl:pl-38 xl:pr-35 lg:pl-5 md:leading-3 lg:leading-4 xl:leading-4 xl:tracking-wide text-gray-500 font-[SFProDisplay]">
        <p>
          ...
          availability and system requirements, see support.apple.com/121115.
        </p>
        <p>
          ∆∆ Testing conducted by Apple in July 2025 using AirPods Pro 3 paired
          ...
          against the bestselling wireless in-ear headphones commercially
        ...
        <p>
          ...
          at 15.99% p.a. over a 6-month tenure. Monthly pricing is rounded to
        ...
        <p>
          ...
          here(opens in new window) to see instant cashback amounts and eligible
          ...
          apply(opens in new window). Instant cashback is not available to
        ...
        <p>
          ...
          trial. Apple TV subscription does not include third-party branded
          subscription services or content available for rental or purchase in
          the Apple TV app. Only one offer per Apple Account and only one offer
          per family if you're part of a Family Sharing group, regardless of the
          number of devices that you or your family purchase. This offer is not
          available if you or your family have previously accepted an Apple TV
          subscription three-months-free or one-year-free offer. Offer valid for
          three months after eligible device has been activated. Plan
        ...
        <p>
          ...
          offerterms(opens in new window) apply.
        </p>
        <p>
