const Part1 = () => {
  return (
    <>
      <div className="pl-4 pr-4.5 text-[0.75rem] mt-8.5 tracking-wide space-y-2 xl:space-x-4 leading-4 md:leading-3 lg:leading-4 xl:leading-4 xl:tracking-wide text-gray-600 font-[SFProDisplay]">
        <p>
